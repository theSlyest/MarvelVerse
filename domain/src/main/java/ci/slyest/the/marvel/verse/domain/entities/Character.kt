...
data class Character (
    ...
    val comics: ResourceList, // optional: A resource list containing comics which feature this character.
    val stories: StoryList, // optional: A resource list of stories in which this character appears.
    val events: ResourceList, // optional: A resource list of events in which this character appears.
